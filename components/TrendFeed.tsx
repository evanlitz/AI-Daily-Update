              ...
              <div key={key} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <div style={{
                    ...
                    background: active ? st.color : '#3f3f46',
                    transition: 'background 0.3s',
                  }} />
                  <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: 'transparent', color: refreshing ? '#3f3f46' : '#71717a',
                  border: '1px solid var(--border)',
          ...
          <div style={{
            ...
            <div style={{ position: 'relative' }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round"
                style={{ position: 'absolute', left: 10, top: '50%', transform: 'translateY(-50%)', width: 14, height: 14, color: '#52525b', pointerEvents: 'none' }}>
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      onMouseEnter={e => {
                        if (!isRead) (e.currentTarget as HTMLElement).style.background = `rgba(${src.rgb},0.03)`
                      }}
                      onMouseLeave={e => {
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 7 }}>
                          ...
                          {(item.summary || item.raw_content) && !expanded && (
                            <span style={{ fontSize: 11, color: item.summary ? '#60a5fa' : '#52525b' }}>
                    ...
                    {expanded && (item.summary || item.raw_content) && (
                      <div className="fade-up" style={{ padding: '0 16px 16px', paddingLeft: 91 }}>
                        <div style={{
                          ...
                          border: `1px solid ${item.summary ? 'rgba(59,130,246,0.15)' : 'rgba(255,255,255,0.07)'}`,
